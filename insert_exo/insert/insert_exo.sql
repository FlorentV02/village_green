...
-- 6. Afficher les employés licenciés depuis plus de 3 ans
...
-- 7. Afficher les produits dont le prix est supérieur à 100€
...
-- 8. Afficher les produits dont le stock est inférieur aux stock d'alerte.
...
-- 9 Afficher tous les produits de la catégorie "guitares". N'oubliez pas les sous-catégories.
...
-- 10. Afficher les catégories des produits vendus par les fournisseurs du Chili.
...
-- On joint la table Fournisseurs nécessaire pour obtenir accéder à la table pays via la clé étrangèrepro_fou_id et pro_id
...
-- 11 Afficher le catalogue des produits par catégorie, le nom des produits et de la catégorie doivent être affichés. 
